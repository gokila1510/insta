                    ...
                    Stack(
                        children:[
                          Padding(
                            ...
                            child: CircleAvatar(
                              radius: 11,
                              backgroundImage: NetworkImage("https://yt3.googleusercontent.com/ytc/AL5GRJVZqekX2KBNTbss7v_XMm-I1RKcXd5G6PTD_Va77Q=s900-c-k-c0x00ffffff-no-rj"),
                            ),
                          ),
                          Padding(
                            ...
                            child: CircleAvatar(
                              radius: 11,
                              backgroundImage: NetworkImage("https://i.ytimg.com/vi/ayb4EKgmYTw/hq720_2.jpg?sqp=-oaymwEYCMAEENAFSFryq4qpAwoIARUAAIhC0AEB&rs=AOn4CLB4GGZ007HSpwFbOq-_NvyFbRmMYQ"),
                            ),
                          ),
                          Padding(
                            ...
                            Container(
                              ...
                              child: Wrap
                                (
                                  ...
                                  children:[ Text(
                                    'Liked by '+likedBy+ ' and 1,12,000 ohters',softWrap:true,
            ...
            Padding(
              ...
              child:Wrap(
                  ...
                  children:[
                    ...
                    Text(description,style: TextStyle(color: Colors.white,),softWrap: true),
                  ...
                  Row(
                      children:[
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal:30),
                          child:
                          Text("themessistore    ",style: TextStyle(color: Colors.white),),
                  ...
                  Row(
                      children:[
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal:30),
                          child:
                          Text("muhamedbinkhalifa     ",style: TextStyle(color: Colors.white),),
